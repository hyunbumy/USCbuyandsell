					...
					<li><a href="#">Departments</a>
						<ul>
						    <li><a href="search?category=Book&term=">Book</a></li>
					      	...
					      	<li><a href="search?category=Car&term=">Car</a></li>
					      	<li><a href="search?category=Furniture&term=">Furniture</a></li>
					      	<li><a href="search?category=Music&term=">Music</a></li>
					      	<li><a href="search?category=Appliance&term=">Appliance</a></li>
					      	<li><a href="search?category=Housing&term=">Housing</a></li>
					      	<li><a href="search?category=Jewlery&term=">Jewlery</a></li>
					      	<li><a href="search?category=Other&term=">Other</a></li>
					   	</ul>
					</li>
